...
export default function Sidebar() {
  return (
    <div className=" w-[100px] h-[633px] overflow-y-scroll mt-6 bg-gray-50 flex flex-col justify-between items-center py-4 shadow-md scrollable-container overflow-hidden">
      {/* Top Icon */}
      <div className="">
